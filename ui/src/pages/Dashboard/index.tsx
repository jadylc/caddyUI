					...
					<div className="row row-cards">
						<HasPermission section={PROXY_HOSTS} permission={VIEW} hideError>
							<div className="col-sm-6 col-lg-3">
								<a
									href="/caddy/proxy"
									className="card card-sm card-link card-link-pop dashboard-card"
									onClick={(e) => {
										e.preventDefault();
										navigate("/caddy/proxy");
									}}
								>
						...
						<HasPermission section={REDIRECTION_HOSTS} permission={VIEW} hideError>
							<div className="col-sm-6 col-lg-3">
								<a
									href="/caddy/redirection"
									className="card card-sm card-link card-link-pop dashboard-card"
									onClick={(e) => {
										e.preventDefault();
										navigate("/caddy/redirection");
									}}
								>
									<div className="card-body">
										<div className="row align-items-center">
